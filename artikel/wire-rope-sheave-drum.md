---
article_id: KAW-14-04
title: "Sheave, Drum, Fleet Angle, dan Umur Wire Rope"
slug: "wire-rope-sheave-drum"
description: "Explain bending cycles, groove condition, alignment/fleet concepts, crushing, spooling, and inspection questions"
status: outline
publication_date: "2026-02-21"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: KAW-14
primary_intent: "Understand system-caused wear"
reader_community: "Besi.co.id"
reader_address: "Kawan Besi.co.id"
final_route: "/artikel/wire-rope-sheave-drum.html"
...
# Sheave, Drum, Fleet Angle, dan Umur Wire Rope

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Sheave, Drum, Fleet Angle, dan Umur Wire Rope”
- **Reader and situation:** Equipment owner seeing repeat rope damage
- **Reader outcome:** Explain bending cycles, groove condition, alignment/fleet concepts, crushing, spooling, and inspection questions
- **Primary intent:** Understand system-caused wear
- **Reader community:** `Besi.co.id`
- **Primary friendly address:** `Kawan Besi.co.id`
- **Natural variants:** `Sobat Besi.co.id` and `Teman Besi.co.id`
- **Address cadence:** use a friendly project-community address three to five times in a typical long article, only at natural conversational pivots.
- **Scope boundary:** Does not calculate geometry or approve equipment; manufacturer/engineer criteria govern
- **Final public route:** `/artikel/wire-rope-sheave-drum.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Sheave, Drum, Fleet Angle, dan Umur Wire Rope**.
...
- **Exact Markdown to insert:** `![Ilustrasi Wire Rope 2](/wp-content/uploads/2026/04/Wire-Rope-2.jpg)`
- **Caption/credit:** Aset lokal proyek; jangan klaim sebagai dokumentasi proyek tertentu.
- **Selection basis:** filename/source metadata identifies `Wire Rope 2` as relevant content media; no pixels were inspected.
...
- **TOPIC-GATE:** G-01, G-02, G-03, G-11, G-13.
...
- `KAW-14-02` → `/artikel/memilih-wire-rope.html` — Memilih Wire Rope Berdasarkan Sistem, Gerak, dan Lingkungan
- `KAW-14-03` → `/artikel/mengukur-diameter-wire-rope.html` — Cara Mengukur Diameter Wire Rope dengan Benar
- `KAW-14-05` → `/artikel/inspeksi-kerusakan-wire-rope.html` — Inspeksi Wire Rope: Broken Wire, Kink, Birdcage, dan Korosi
- `KAW-14-06` → `/artikel/perawatan-dan-penggantian-wire-rope.html` — Penyimpanan, Pelumasan, dan Penggantian Wire Rope
...
- **Tie back to this article:** Keep the explanation specific to “Sheave, Drum, Fleet Angle, dan Umur Wire Rope”.
