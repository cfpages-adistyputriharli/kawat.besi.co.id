---
article_id: KAW-14-01
title: "Anatomi Wire Rope: Wire, Strand, Core, Lay, dan Terminasi"
slug: "anatomi-wire-rope"
description: "Explain wires, strands, core, lay direction, diameter, lubrication, termination, and system interfaces"
status: outline
publication_date: "2026-02-09"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: KAW-14
primary_intent: "Understand steel cable construction"
reader_community: "Besi.co.id"
reader_address: "Sobat Besi.co.id"
final_route: "/artikel/anatomi-wire-rope.html"
...
# Anatomi Wire Rope: Wire, Strand, Core, Lay, dan Terminasi

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Anatomi Wire Rope: Wire, Strand, Core, Lay, dan Terminasi”
- **Reader and situation:** Buyer or operator reading a rope description
- **Reader outcome:** Explain wires, strands, core, lay direction, diameter, lubrication, termination, and system interfaces
- **Primary intent:** Understand steel cable construction
- **Reader community:** `Besi.co.id`
- **Primary friendly address:** `Sobat Besi.co.id`
- **Natural variants:** `Kawan Besi.co.id` and `Teman Besi.co.id`
- **Address cadence:** use a friendly project-community address three to five times in a typical long article, only at natural conversational pivots.
- **Scope boundary:** Does not select lifting capacity; competent lifting design and manufacturer data govern
- **Final public route:** `/artikel/anatomi-wire-rope.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Anatomi Wire Rope: Wire, Strand, Core, Lay, dan Terminasi**.
...
- **Tie back to this article:** Keep the explanation specific to “Anatomi Wire Rope: Wire, Strand, Core, Lay, dan Terminasi”.
