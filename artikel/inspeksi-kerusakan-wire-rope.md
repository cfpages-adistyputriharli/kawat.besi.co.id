---
article_id: KAW-14-05
title: "Inspeksi Wire Rope: Broken Wire, Kink, Birdcage, dan Korosi"
slug: "inspeksi-kerusakan-wire-rope"
description: "Build a documented visual/tactile inspection path, defect vocabulary, isolation triggers, and evidence record"
status: outline
publication_date: "2026-02-26"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: KAW-14
primary_intent: "Recognize dangerous rope conditions"
reader_community: "Besi.co.id"
reader_address: "Sobat Besi.co.id"
final_route: "/artikel/inspeksi-kerusakan-wire-rope.html"
...
# Inspeksi Wire Rope: Broken Wire, Kink, Birdcage, dan Korosi

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Inspeksi Wire Rope: Broken Wire, Kink, Birdcage, dan Korosi”
- **Reader and situation:** Competent-person trainee or owner
- **Reader outcome:** Build a documented visual/tactile inspection path, defect vocabulary, isolation triggers, and evidence record
- **Primary intent:** Recognize dangerous rope conditions
- **Reader community:** `Besi.co.id`
- **Primary friendly address:** `Sobat Besi.co.id`
- **Natural variants:** `Kawan Besi.co.id` and `Teman Besi.co.id`
- **Address cadence:** use a friendly project-community address three to five times in a typical long article, only at natural conversational pivots.
- **Scope boundary:** Does not publish universal discard numbers; current standard, manufacturer, and competent person own retirement
- **Final public route:** `/artikel/inspeksi-kerusakan-wire-rope.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Inspeksi Wire Rope: Broken Wire, Kink, Birdcage, dan Korosi**.
...
- **Exact Markdown to insert:** `![Ilustrasi Wire Rope 4](/wp-content/uploads/2026/04/Wire-Rope-4.webp)`
- **Caption/credit:** Aset lokal proyek; jangan klaim sebagai dokumentasi proyek tertentu.
- **Selection basis:** filename/source metadata identifies `Wire Rope 4` as relevant content media; no pixels were inspected.
...
- `KAW-14-04` → `/artikel/wire-rope-sheave-drum.html` — Sheave, Drum, Fleet Angle, dan Umur Wire Rope
...
- **Tie back to this article:** Keep the explanation specific to “Inspeksi Wire Rope: Broken Wire, Kink, Birdcage, dan Korosi”.
